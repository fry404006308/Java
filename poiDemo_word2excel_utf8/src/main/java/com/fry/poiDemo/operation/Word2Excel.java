...
import com.fry.poiDemo.service.ExcelService;
...
public class Word2Excel {
	...
	public void mainOperation(){
		...
		String excelFile="myRes//excel//ans1.xlsx";
		//2、从word中读取数据
		WordService wordService = new WordService();
		Exam exam1=new Exam();
		wordService.readWord(wordFile, imageFile,exam1);
		//3、把数据写到excel中
		ExcelService excelService = new ExcelService();
		excelService.writeExcel(exam1,excelFile);
	}
}
